namespace Machete.X12Schema.V5010.Maps
{
        ...
        X12SegmentMap<SLI, X12Entity>
    {
        public SLIMap()
        {
            ...
            Value(x => x.MonetaryAmount1, 2, x=> x.MinLength(1).MaxLength(18).IsRequired());
            Value(x => x.MonetaryAmount2, 3, x=> x.MinLength(1).MaxLength(18).IsRequired());
            Value(x => x.InterestRate, 4, x=> x.MinLength(1).MaxLength(6).IsRequired());
            Value(x => x.LoanRateTypeCode, 5, x=> x.FixedLength(1).IsRequired());
            Value(x => x.DateTimePeriodFormatQualifier1, 6, x=> x.MinLength(2).MaxLength(3));
            ...
            Value(x => x.DateTimePeriodFormatQualifier2, 10, x=> x.MinLength(2).MaxLength(3));
            Value(x => x.DateTimePeriod2, 11, x=> x.MinLength(1).MaxLength(35));
            Value(x => x.DateTimePeriodFormatQualifier3, 20, x=> x.MinLength(2).MaxLength(3));
            Value(x => x.DateTimePeriod3, 13, x=> x.MinLength(1).MaxLength(35));
            Value(x => x.MonetaryAmount3, 14, x=> x.MinLength(1).MaxLength(18));
            ...
            Value(x => x.DateTimePeriodFormatQualifier4, 20, x=> x.MinLength(2).MaxLength(3));
            Value(x => x.DateTimePeriod4, 21, x=> x.MinLength(1).MaxLength(35));
